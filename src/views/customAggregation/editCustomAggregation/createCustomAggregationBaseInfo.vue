  ...
  <div class="container-box">
    <el-card class="el-card-mt20" shadow="hover">
      ...
      <el-form ref="componentForm" label-position="left" :model="componentForm" :rules="rules" label-width="140px" class="componentForm" size="medium">
        <el-form-item label="聚合名称" prop="businessPerson" required>
          <el-input v-model="componentForm.polyName" :clearable="true" placeholder="请输入自定义聚合名称，将显示于用户端（最多7个字）" />
        </el-form-item>
        <el-form-item label="聚合对象" prop="merchantType">
        ...
        <el-form-item label="分享链接显示内容" prop="merchantType">
        ...
        <template v-if="componentForm.shareType == 'CUSTOM'">
          <el-form-item label="分享标题" prop="merchantType">
...
export default {
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file) {
      if (res.type === AjaxReturnType.SUCCESS) {
        this.componentForm.shareImageUrl = res.data.imgUrl
        // this.bannerPicErrorMessage = ''
