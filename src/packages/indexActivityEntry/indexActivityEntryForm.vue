<template>
  <el-form :model="componentForm" :rule="componentRule" label-width="98px">
    <el-form-item prop="src" label="banner图片">
    ...
    <el-form-item v-if="componentForm.linkType==&quot;url&quot;" label="跳转url" prop="href">
